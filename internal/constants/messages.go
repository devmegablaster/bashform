...
const (
	...
	MessageFormCreateError        = "Error creating form: %s"
	MessageCommandHeader          = "Command to fill this form:"
	MessageCommand                = "ssh -t %s f %s"
	MessageErrorCodeAlreadyExists = "Form with the same code already exists!"
)
